...
import Imgcy  from './../../Components/Image/front-frame-bag.jpg'
import Image1 from './../../Components/Image/SHORTS.jpg'
...
import './../Hockey/hocky.css'
  ...
  function Hockey(){
   ...
   <div className='container1'>
           ...
           <div className='c1'>
              <img className='tri'src={Image1}/>
             <h1 className='spga'>Shorts</h1>
             <span className='que'>Prize : ₹350 <del className='del'>  M.R.P. : ₹749</del> </span> <p className='sav'>Save upto 60%<button className='incre'onClick={inc}>+</button>{count}<button className='decre'onClick={dec}>-</button></p>
             <div className='star'>
           ...
           <div className='c1'>
              <img className='tri'src={"https://www.sefiles.net/merchant/4598/images/site/1540841266449.jpg"}/>
          ...
          <div className='star'>
            ...
            <div className='c1'>
              <img className='tri'src={"https://www.sefiles.net/merchant/4598/images/site/1540841197922-slimC.jpg?t=1540841214615"}/>
...
<div className='c1'>
  <img className='tri'src={"https://www.sefiles.net/merchant/4598/images/site/1540841033965.jpg"}/>
...
<div className='c1'>
  <img className='tri'src={"https://www.sefiles.net/merchant/4598/images/site/1540840987688.jpg"}/>
...
<div className='c1'>
  <img className='tri'src={ "https://www.sefiles.net/merchant/4598/images/site/1540840944926.jpg"}/>
...
<div className='c1'>
   <img className='tri'src={"https://www.sefiles.net/merchant/4598/images/site/1540840906557.jpg"}/>
...
<div className='c1'>
   <img className='tri'src={"https://www.sefiles.net/merchant/4598/images/site/1540840856785.jpg"}/>
 ...
 <div className='c1'>
   <img className='tri'src={"https://rukminim2.flixcart.com/image/612/612/xif0q/cyclocomputer/7/o/r/bicycle-computer-odometer-speedometer-wired-cyclocomputer-original-imaggwwffssspnkh.jpeg?q=70"}/>
