...
import img4 from './../../Components/Image/images/link.jpg'
import img5 from './../../Components/Image/images/inst.jpg'
import img6 from './../../Components/Image/images/git hub.jpg'
import img7 from './../../Components/Image/images/road.jpg'
import img8 from './../../Components/Image/images/sa.jpg'
import img9 from './../../Components/Image/images/ve.jpg'
import img10 from './../../Components/Image/images/pi.jpg'
import img11 from './../../Components/Image/images/bh.jpg'
import img12 from './../../Components/Image/images/anu.jpg'
...
<div className="col-md-12 text-center">
  ...
  <p className="secontion-subtitle">
  </p>
</div>
<div className="col-sm-6 col-md-4">
 ...
 <img src={img5}className="symbol"></img>
        ...
        <a href="https://www.linkedin.com/in/659951222/" className="facebook">
...
<div className="col-sm-6 col-md-4">
    <div className="team-item">
        <img src={img10} className="team-img "alt="pic"></img>
        <h3> {name_3}</h3>
...
<div className="col-sm-6 col-md-4">
 ...
 <img src={img5}className="symbol"></img>
        ...
        <a href="https://www.linkedin.com/i659951222/" className="facebook">
<img src={img6}className="symbol"></img>
        </a>&nbsp;
        <a href="https://r.search.yahoo.com/_ylt=Awrx.1LdEihlXyAQQ7i7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Ny/RV=2/RE=1697153886/RO=10/RU=https%3a%2f%2fwww.roadtocode.org%2f/RK=2/RS=YBGqu6wRyL9Uyb7Hc9YLQSVMYpc-" className="dribbble">
<img src={img7}className="symbol"></img>
...
<div className="col-sm-6 col-md-4">
 ...
 <img src={img5}className="symbol"></img>
        ...
        <a href="https://www.linkedin.com/il-659951222/" className="facebook">
<img src={img6}className="symbol"></img>
        </a>&nbsp;
        <a href="https://r.search.yahoo.com/_ylt=Awrx.1LdEihlXyAQQ7i7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Ny/RV=2/RE=1697153886/RO=10/RU=https%3a%2f%2fwww.roadtocode.org%2f/RK=2/RS=YBGqu6wRyL9Uyb7Hc9YLQSVMYpc-" className="dribbble">
<img src={img7}className="symbol"></img>
...
<div className="col-sm-6 col-md-4">
    <div className="team-item">
        <img src={img12} className="team-img "alt="pic"></img>
        <h3>{name_6}</h3>
        <div className="team-info">
